...
<div class="wp-block-olena-floating-box" style="right:0%;bottom:0%" data-orientation="3" data-position-left="0" data-position-top="0" data-position-right="0" data-position-bottom="0"><!-- wp:olena/responsive-box {"unique_class":"mx-responsive-box-bawrrvdTklrn"} -->
<div data-breakpoint="all" class="mx-responsive-box mx-responsive-box-bawrrvdTklrn"><div class="wp-block-olena-responsive-box"><style></style><!-- wp:image {"id":61,"width":"610px","height":"auto","sizeSlug":"full","linkDestination":"none"} -->
...
<!-- wp:woocommerce/product-price {"isDescendentOfQueryLoop":true,"textAlign":"center","fontFamily":"roboto","fontSize":"xx-small","style":{"typography":{"fontStyle":"normal","fontWeight":"700"}}} /-->
