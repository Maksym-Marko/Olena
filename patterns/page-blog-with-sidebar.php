...
<div class="wp-block-group is-style-animation-wrapper" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:var(--wp--preset--spacing--medium);padding-bottom:0;padding-left:var(--wp--preset--spacing--medium)"><!-- wp:olena/floating-box -->
<div class="wp-block-olena-floating-box" style="right:3%;top:0%" data-orientation="2" data-position-left="0" data-position-top="0" data-position-right="3" data-position-bottom="0"><!-- wp:olena/responsive-box {"unique_class":"mx-responsive-box-1E4DdmdsC7XM"} -->
<div data-breakpoint="all" class="mx-responsive-box mx-responsive-box-1E4DdmdsC7XM"><div class="wp-block-olena-responsive-box"><style></style><!-- wp:image {"id":257,"width":"428px","height":"auto","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
...
<h2 class="wp-block-heading"><?php printf( esc_html__( '%s', 'olena' ), __( 'Blog', 'olena' ) ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h5 class="wp-block-heading has-text-align-left has-dark-color has-text-color has-link-color has-roboto-font-family has-x-small-font-size" style="margin-top:var(--wp--preset--spacing--medium);padding-bottom:0px;letter-spacing:1px;text-transform:none"><?php printf( esc_html__( '%s', 'olena' ), __( 'More Here', 'olena' ) ); ?></h5>
<!-- /wp:heading -->
...
<h5 class="wp-block-heading has-text-align-left has-dark-color has-text-color has-link-color has-roboto-font-family has-x-small-font-size" style="margin-top:var(--wp--preset--spacing--medium);padding-bottom:0px;letter-spacing:1px;text-transform:none"><?php printf( esc_html__( '%s', 'olena' ), __( 'Categories', 'olena' ) ); ?></h5>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-dark-color has-text-color has-link-color has-xx-small-font-size"><?php printf( esc_html__( '%s', 'olena' ), '<a href="' . esc_url( 'https://olena-theme.com.ua/olena-releases/' ) . '">' . __( 'Olena theme Release', 'olena' ) . '</a>' ); ?></h3>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
