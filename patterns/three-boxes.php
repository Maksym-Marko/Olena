...
<div data-breakpoint="desktop" class="mx-responsive-box mx-responsive-box-ww7doMPTz539"><div class="wp-block-olena-responsive-box"><style>@media (max-width: 991.5px) {
	...
	.editor-styles-wrapper .mx-responsive-box.mx-responsive-box-ww7doMPTz539 {
...
<?php printf( esc_html__( '%s', 'olena' ), __( 'Follow these 3 simple steps to launch your website effortlessly with <strong>Olena Theme</strong>. It&#39;s easier than you imagine!', 'olena' ) ); ?>
...
<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php echo esc_html__( 'Experience the joy of unlimited customization with Olena theme', 'olena' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:olena/animated-box --></div>
