...
?>
<!-- wp:group {"tagName":"section","metadata":{"categories":["featured"],"patternName":"olena/section-with-slider","name":"Section With a Slider"},"align":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large","right":"var:preset|spacing|mini","left":"var:preset|spacing|mini"}}},"backgroundColor":"main-light","layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull has-main-light-background-color has-background" id="section-with-slider" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xx-large);padding-right:var(--wp--preset--spacing--mini);padding-bottom:var(--wp--preset--spacing--xx-large);padding-left:var(--wp--preset--spacing--mini)"><!-- wp:columns -->
...
<h4 class="wp-block-heading has-main-color has-text-color" style="font-style:normal;font-weight:100">Dynamic Animations</h4>
<!-- /wp:heading -->

<!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":1.2}},"fontSize":"medium","fontFamily":"roboto-light"} -->
<h3 class="wp-block-heading has-roboto-light-font-family has-medium-font-size" style="line-height:1.2">Engage Your Visitors</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":1.3}},"fontSize":"x-small"} -->
<p class="has-x-small-font-size" style="line-height:1.3">Enhance your website with captivating animations that bring images, texts, and sections to life!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-button is-style-main-outline"><a class="wp-block-button__link wp-element-button" href="#animated-horizontal">View Olena animations</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:olena/animated-box -->
...
<p>Easily Add Animations via Admin Panel</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-group has-light-background-color has-background" style="min-height:140px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:paragraph -->
<p>Save Costs Without Hiring a Programmer</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
