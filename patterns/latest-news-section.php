 ...
 * Slug: olena/latest-news-section
...
?>
<!-- wp:group {"tagName":"section","metadata":{"categories":["posts"],"patternName":"olena/latest-news-section","name":"Latest News Section"},"align":"full","className":"is-style-animation-wrapper","style":{"spacing":{"padding":{"right":"var:preset|spacing|small","left":"var:preset|spacing|small","top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|xx-large"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull is-style-animation-wrapper" id="latest-news" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--xx-large);padding-left:var(--wp--preset--spacing--small)"><!-- wp:olena/floating-box -->
<div class="wp-block-olena-floating-box" style="left:5%;top:12%" data-orientation="1" data-position-left="5" data-position-top="12" data-position-right="-13" data-position-bottom="0"><!-- wp:olena/responsive-box {"unique_class":"mx-responsive-box-DOrDhLXe1Gid"} -->
<div data-breakpoint="desktop" class="mx-responsive-box mx-responsive-box-DOrDhLXe1Gid"><div class="wp-block-olena-responsive-box"><style>@media (max-width: 991.5px) {
	.mx-responsive-box.mx-responsive-box-DOrDhLXe1Gid {
		display: none !important;
	}
	.editor-styles-wrapper .mx-responsive-box.mx-responsive-box-DOrDhLXe1Gid {
		display: block !important;
		opacity: 0.5;
	}
}
</style><!-- wp:image {"id":257,"width":"553px","height":"553px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/animations/bubble_5.svg" alt="" class="wp-image-257" style="width:553px;height:553px"/></figure>
<!-- /wp:image --></div></div>
...
<div class="wp-block-olena-animated-box" data-animation-type="zoomIn" data-extras=""><!-- wp:query {"queryId":1,"query":{"perPage":"3","pages":"0","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"align":"full"} -->
...
<div class="wp-block-group alignwide has-tertiary-background-color has-background" style="padding-top:var(--wp--preset--spacing--small);padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:post-template {"align":"wide","className":"is-style-grid-modern","textColor":"dark","layout":{"type":"grid","columnCount":2}} -->
<!-- wp:group {"className":"is-style-animation-wrapper","style":{"spacing":{"blockGap":"0","padding":{"top":"0","right":"0","bottom":"0","left":"0"},"margin":{"top":"0","bottom":"0"}},"border":{"radius":"0px"}}} -->
...
<!-- wp:group {"className":"is-style-animation-pointer","style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium"}},"border":{"radius":"0px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group is-style-animation-pointer" style="border-radius:0px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:group {"className":"is-style-default","style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium"}}},"layout":{"type":"constrained","contentSize":""}} -->
